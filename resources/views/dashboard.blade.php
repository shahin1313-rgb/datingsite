...
@section('content')
    ...
    <main class="main-content w-full flex-1 p-4 md:p-8">
        <div
            ...
            class="relative min-h-screen flex flex-row-reverse"
        >
            <aside
            ...
            >
                <div class="flex flex-col items-center py-6 mb-6">
                    ...
                    <span class="mt-3 font-bold text-sm">
                        {{ auth()->user()->name }}
                    </span>
                </div>
                ...
                <nav class="space-y-2 flex-1 overflow-y-auto">
                    <a
                        ...
                        class="flex items-center justify-start gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition"
                    >
                        <i class="fa fa-th-large w-5"></i>
                        <span>داشبورد</span>
                    </a>
                    ...
                    <a
                        ...
                        class="flex items-center justify-start gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition"
                    >
                        <i class="fa fa-ticket-alt w-5"></i>
                    ...
                    <a
                        ...
                        class="flex items-center justify-start gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition"
                    >
                        <i class="fa fa-user-slash w-5"></i>
                        <span>لیست سیاه</span>
                    </a>

                    <a
                        href="{{ route('premium.upgrade') }}"
                        class="flex items-center justify-start gap-3 p-3 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/50 transition"
                    >
                        <i class="fa fa-crown text-amber-400 w-5"></i>
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="w-full flex items-center justify-start gap-3 p-3 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 transition"
                        >
            ...
            <div class="flex-1 flex flex-col min-w-0 bg-gray-50">
                <div class="animate-slide-in">
                    <div
                        class="relative bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-8"
                    >
                        <div
                            class="h-32 bg-gradient-to-r from-pink-500 to-orange-400"
                        ></div>

                        <div class="px-6 pb-6">
                            <div
                                class="relative flex flex-col md:flex-row items-center md:items-end -mt-16 md:-mt-12 gap-5"
                            >
                                ...
                                <div
                                    class="flex-1 text-center md:text-right mb-2"
                                >
                                    <h1
                                    ...
                                    <p
                                        class="text-gray-500 flex items-center justify-center md:justify-start gap-2"
                                    >
                                        <i
                                            class="fa fa-map-marker-alt text-pink-500"
                                        ></i>
                                ...
                                <div class="flex gap-3 mb-2">
                                    ...
                                    <button
                                        type="button"
                                        class="p-2 bg-pink-50 text-pink-600 rounded-2xl hover:bg-pink-600 hover:text-white transition"
                            ...
                            <div
                                class="flex justify-center md:justify-start gap-8 mt-8 border-t pt-6"
                            >
                                <div class="text-center">
                                    <span
                                        class="block text-xl font-black text-gray-800"
                                    >
                                        {{ $likesCount ?? 0 }}
                                    </span>
            ...
            >
                ...
                <div
                    class="relative bg-white rounded-3xl shadow-2xl w-full max-w-xs p-6 text-center transform transition-all"
                    @click.stop
                >
                    <div
                    ...
                    <div class="flex gap-2">
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                class="w-full py-2 bg-red-500 text-white rounded-xl font-bold hover:bg-red-600 shadow-md"
                            >
                                خروج
                            </button>
                        </form>
            ...
            <div
                ...
                class="fixed inset-0 bg-black/50 z-[35] md:hidden backdrop-blur-sm"
            ></div>
        </div>
    </main>
@endsection