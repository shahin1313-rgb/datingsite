            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="city" name="city" id="city" value="{{ request('city') }}" aria-label="city" aria-describedby="basic-addon1">
                      </div>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="age"> min age:</span>
                        </div>
                        <input   type="number" name="min_age" id="min_age" value="{{ request('min_age') }}" class="form-control" placeholder="age" aria-label="age" aria-describedby="basic-addon1">

                        <div class="input-group-prepend">
                            <span class="input-group-text" id="age"> Max age:</span>
                          </div>
                          <input   type="number" name="max_age" id="max_age" value="{{ request('max_age') }}" class="form-control" placeholder="age" aria-label="age" aria-describedby="basic-addon1">
                                ...
                                @foreach ($profiles as $profile)
                                    <li class="mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('profile.show', $profile->id) }}" class="btn btn-primary">View Profile</a>
