...
@section('content')
    <div class="container">
        ...
        <div class="chat-container container-fluid full-height d-flex flex-column">
            ...
            <div class="message-container">
                ...
                <div class="input-group  ">
                    <form action="{{ route('messages.store', $user) }}" method="POST" class="form-control">
                @csrf
                    <textarea name="message" class="form-control flex-grow-1" rows="1" placeholder="Type a message..." style="resize: none max-height: 150px;"
                        required></textarea>
