...
<body class="bg-gradient-to-br from-pink-50 via-white to-purple-50 h-screen flex items-center justify-center">
    <div class="text-center px-6">
        <h1 class="text-9xl font-extrabold text-pink-500">404</h1>
